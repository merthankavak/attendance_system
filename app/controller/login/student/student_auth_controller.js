...
const StudentToken = require('../model/student/student_token_model');
...
// @route GET api/auth/student/verify/:token
// @desc Verify token
    ...
    try {
        ...
        await sendEmail({
            ...
            dynamicTemplateData: {
                ...
                fullname: fullName,
                verifyUrl: "https://" + req.headers.host + "/api/auth/student/verify/" + studentToken.token,
